...
class Tester {
  ...
  constructor(component, options = {}) {
    ...
    } else if (this.options != null ? this.options.debug : undefined) {
  ...
  start(done) {
    ...
    const whenReady = () => {
      ...
      this.ins = {};
      this.outs = {};
      if (this.tracer && this.c.isSubgraph() && this.c.network) {
        // Attach tracer
        this.c.network.setFlowtrace(this.c.network, this.component, true);
      }
